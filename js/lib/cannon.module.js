...
// Simplified CannonJS module for Skate Park Pro

// Create CANNON namespace
const CANNON = {
    // Vec3 class
    Vec3: class Vec3 {
    ...
    Body: class Body {
        constructor(options = {}) {
            ...
            this.type = this.mass > 0 ? CANNON.Body.DYNAMIC : CANNON.Body.STATIC;
            this.shapes = [];
    ...
    Box: class Box extends CANNON.Shape {
    ...
    Plane: class Plane extends CANNON.Shape {
        constructor() {
            super();
        }
    },
    
    Sphere: class Sphere extends CANNON.Shape {
        constructor(radius) {
            super();
            this.radius = radius;
        }
